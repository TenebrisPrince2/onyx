...
window.AppDomain = {
  entities: { accById: accById, catById: catById, catsOf: catsOf, topCats: topCats, childrenOf: childrenOf, rootOf: rootOf, catCur: catCur, sysAcc: sysAcc, SYS_ACC_DEFS: SYS_ACC_DEFS, isCategoryHidden: isCategoryHidden, isAccountHidden: isAccountHidden, isTxnOverviewVisible: isTxnOverviewVisible },
